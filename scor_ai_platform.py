...
if page == "🏠 الصفحة الرئيسية":
    ...
    st.title("منصة التحليل الذكي لأداء سلاسل الإمداد")
    st.markdown("---")

    st.subheader("🧑‍🎓 بيانات الطالبة")
    st.markdown("""
    - **الاسم:** سها ناصر سعيد عماره  
    - **الكلية:** كلية التجارة – جامعة القاهرة  
    - **الفرقة:** الرابعة – شعبة نظم معلومات  
    - **مشرف المشروع:** أ.د. عماد قمحاوي  
    """)

    st.subheader("📘 عنوان مشروع التخرج")
    st.markdown("""
    **Smart AI Benchmarking Platform for Supply Chain Excellence using SCOR Model**  
    منصة ذكية لتقييم وتحليل أداء سلاسل الإمداد باستخدام نموذج SCOR والذكاء الاصطناعي.
    """)

    st.subheader("🎯 فكرة المشروع")
    st.markdown("""
    ...
    بالإضافة إلى التكامل مع أنظمة مثل Odoo وPower BI.
    """)

    st.subheader("📬 تواصل معي")
    st.markdown("""
    - البريد الإلكتروني: sohaemara22@gmail.com  
    """)
